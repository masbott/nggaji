                  ...
                  <?php $no = 1; foreach( $kriteria->result() as $k ): ?>
                    <tr>
                      ...
                      <td class="text-center">
                        <a href="#" data-id="<?php echo $k->id_kriteria ?>" class="btn btn-xs btn-primary edit"><i class="fa fa-pencil"></i> Edit </a>
                        <a href="<?php echo site_url('master_data/kriteria/delete/'.$k->id_kriteria); ?>" class="btn btn-xs btn-danger" onclick="return confirm('Yakin akan menghapus data ini?')"> <i class="fa fa-trash"></i> Hapus </a>
                      </td>
                    </tr>
                  <?php endforeach; ?>
                </tbody>
